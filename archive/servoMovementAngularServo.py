# deprecated library that is incompatible with Rasp Pi 5
...
#neck movement
horiServo = AngularServo(20, min_angle=-90, max_angle=90, min_pulse_width=0.5/1000, max_pulse_width=2.5/1000)
vertServo = AngularServo(26, min_angle=-90, max_angle=90, min_pulse_width=0.5/1000, max_pulse_width=2.5/1000)
